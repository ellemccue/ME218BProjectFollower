...
#define SERV_0_HEADER "ArenaIndicatorServiceFSM.h"
// the name of the Init function
#define SERV_0_INIT InitArenaIndicatorServiceFSM
// the name of the run function
#define SERV_0_RUN RunArenaIndicatorServiceFSM
...
#if NUM_SERVICES > 1
// the header file with the public function prototypes
#define SERV_1_HEADER "SPIFollowerService.h"
// the name of the Init function
#define SERV_1_INIT InitSPIFollowerService
// the name of the run function
#define SERV_1_RUN RunSPIFollowerService
// How big should this services Queue be?
...
#if NUM_SERVICES > 3
// the header file with the public function prototypes
#define SERV_3_HEADER "ScissorLiftFSM.h"
// the name of the Init function
#define SERV_3_INIT InitScissorLiftFSM
// the name of the run function
#define SERV_3_RUN RunScissorLiftFSM
// How big should this services Queue be?
...
typedef enum
{
  ...
  ES_UNLOCK,
          TransferCompleted,
          ES_STOP_HOLD,
          ES_CCW,ES_FORWARD_FULL_SPEED,ES_FORWARD_HALF_SPEED,
          ES_REVERSE_FULL_SPEED, ES_REVERSE_HALF_SPEED, ES_CW_45,ES_CW, 
          ES_CCW_45, ES_DRIVE_FORWARD_TAPE_DETECTED, ES_ALIGN_BEACON, ES_SEARCH_BEACON,
          ES_SEARCH_LINE, GreenFieldDetected, BlueFieldDetected, GoNeutral, ES_ADJUST_OFFSET, ES_CW_OFFSET, ES_LF_RIGHT, ES_LF_LEFT,ES_ADJUST_OFFSET_CCW,
          LED_ON, LED_OFF, LIFT_GROUND, LIFT_STACK_BOTTOM, LIFT_STACK_MIDDLE, LIFT_STACK_TOP, GROUND_LIMIT_HIT, TOP_LIMIT_HIT, GROUND_REACHED, BOTTOM_STACK_REACHED, MIDDLE_STACK_REACHED, TOP_STACK_REACHED, LIFT_STOP
...
#define TIMER14_RESP_FUNC PostScissorLiftFSM
#define TIMER15_RESP_FUNC PostDCMotorService//PostTestHarnessService0
